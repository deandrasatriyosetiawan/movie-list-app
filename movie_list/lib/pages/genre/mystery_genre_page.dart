...
class MysteryGenrePage extends StatefulWidget {
  const MysteryGenrePage({super.key});

  @override
  State<MysteryGenrePage> createState() => _MysteryGenrePageState();
}

class _MysteryGenrePageState extends State<MysteryGenrePage> {
  ...
  Future<void> getJsonMisteryGenreMovieData(BuildContext context) async {
    var response = await http
      ...
      Uri.parse(
          ...
          "https://api.themoviedb.org/3/discover/movie?api_key=<<your_api_key>>&with_genres=$mysteryGenreId"),
    )
        .timeout(
    ...
    setState(() {
      if (response.statusCode == 200) {
        ...
        mysteryGenreMovie = jsonResponse["results"];
      }
    });
  }
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView.builder(
                      itemCount: mysteryGenreMovie == null
                          ? 0
                          : mysteryGenreMovie!.length,
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: SizedBox.fromSize(
                                  child: Image.network(
                                    "https://image.tmdb.org/t/p/w500${mysteryGenreMovie![index]["poster_path"]}",
                                    width: 96,
                                    height: 115,
                                    fit: BoxFit.cover,
                                  ),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "release date ${mysteryGenreMovie![index]["release_date"]}",
                                      style: TextStyleManager
                                    ...
                                    Text(
                                      "rating ${mysteryGenreMovie![index]["vote_average"]}",
                                      style: TextStyleManager
                                          .releaseDateAndRatingTextStyle,
                                    ),
                                  ],
